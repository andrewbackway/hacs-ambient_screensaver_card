...
const SCHEMA: SchemaEntry[] = [
  ...
  },
  {
    ...
    schema: [
      ...
      { name: "outdoor_temp_fallback_entity", selector: { entity: {} } },
      { name: "outdoor_temp_default", selector: { number: { mode: "box" } } },
      { name: "outdoor_high_entity", selector: { entity: {} } },
      { name: "outdoor_high_fallback_entity", selector: { entity: {} } },
      { name: "outdoor_high_default", selector: { number: { mode: "box" } } },
    ],
  },
  {
    name: "",
    ...
    schema: [
      ...
      { name: "room_temp_climate_entity", selector: { entity: { domain: "climate" } } },
      { name: "room_temp_default", selector: { number: { mode: "box" } } },
...
const LABELS: Record<string, string> = {
  ...
  outdoor_temp_fallback_entity: "Outdoor temperature fallback entity",
  outdoor_temp_default: "Outdoor temperature default",
  outdoor_high_entity: "Outdoor high temperature entity",
  outdoor_high_fallback_entity: "Outdoor high temperature fallback entity",
  outdoor_high_default: "Outdoor high temperature default",
  room_temp_entity: "Room temperature entity",
  room_temp_climate_entity: "Room temperature climate fallback entity",
  room_temp_default: "Room temperature default",
